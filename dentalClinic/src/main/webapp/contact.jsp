                    ...
                    <div class="bg-light rounded h-100 p-5">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>123 Street, borivali Mumbai</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-2">
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">&copy; <a class="text-white border-bottom" href="#">Detal Clinic</a>. All Rights Reserved.</p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Designed by <a class="text-white border-bottom" href="https://htmlcodex.com"> Codeer</a></p>
                </div>
            </div>
        </div>
    </div>
